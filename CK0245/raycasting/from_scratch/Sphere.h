...
class Sphere : public Object {
	...
	virtual double findIntersection(Ray ray) {
		...
		// formula de intersecção usando a formula da esfera.
		...
		if (discriminant > 0) {
			...
			// pode interseptar em um um dos lados da esfera, queremos
			// o primeiro lado a ser interseptado, não o lado que fica atráz.
